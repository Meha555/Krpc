...
bool KrpcChannel::ConnectTo(const std::string &ip, uint16_t port)
{
...
std::optional<std::pair<std::string, uint16_t>> KrpcChannel::QueryServiceHost(ZkClient *zkclient, std::string service_name, std::string method_name)
{
